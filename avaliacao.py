...
class Experimento():
    ...
    def macro_f1_avg(self) -> float:
        ...
        for resultado in self.resultados:
            soma_resultados += resultado.macro_f1
        media_f1 = soma_resultados/len(self.resultados)
        return media_f1
    @property
...
class OtimizacaoObjetivoRandomForest(OtimizacaoObjetivo):
    ...
    def obtem_metodo(self,trial: optuna.Trial)->MetodoAprendizadoDeMaquina:
        ...
        clf_rf = RandomForestClassifier(n_estimators=num_arvores, min_samples_split=min_samples, max_features=max_features, random_state=2)
